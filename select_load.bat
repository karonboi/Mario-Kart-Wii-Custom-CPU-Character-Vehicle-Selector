...
cls
echo.
echo    Select a slot to load the selections: [1/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [2/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [3/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [4/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [5/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [6/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [7/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [8/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [9/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
cls
echo.
echo    Select a slot to load the selections: [10/10]
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
goto scene_confirmLoadSlot

:scene_dataNotExist
cls
echo.
echo    There is nothing to load from slot %slot_num%.
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
:scene_confirmLoadSlot
cls
echo.
echo    ️Load slot %slot_num%?
echo    "%slot_name%"
echo    This will overwrite the selections data from the app's workspace.
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
set prev_slot_num=%slot_num%
set prev_slot_name=%slot_name%
cmdmenusel %bg_color%%hl_color% "   Load" "   Save current data from workspace" "   Cancel"
if %errorlevel% == 1 goto scene_loadSlot
if %errorlevel% == 2 set slottoLoad=%slot_num% && call select_save.bat
if %errorlevel% == 3 goto system_revertLoadSlot
set slot_name=%prev_slot_name%
set slot_num=%prev_slot_num%
goto scene_confirmLoadSlot

:system_revertLoadSlot
set slottoLoad=0
...
:scene_loadSlot
copy "C:\karonboi\KaronWizard\saved_selections\%slot_num%.slt" "C:\karonboi\KaronWizard\tmp\save_slt.bat" > nul
copy "C:\karonboi\KaronWizard\saved_selections\%slot_num%.slt" "C:\karonboi\KaronWizard\tmp\select_data.bat" > nul
call C:\karonboi\KaronWizard\tmp\save_slt.bat
del C:\karonboi\KaronWizard\tmp\save_slt.bat > nul
cls
echo.
echo    Slot %slot_num% is loaded:
echo    "%slot_name%"
echo.
echo ════════════════════════════════════════════════════════════════════════════════════════════
echo.
...
:endoffile
:: *trying to imitate Greninja's croaking noise*
:: Which ends up obliterating my throat
